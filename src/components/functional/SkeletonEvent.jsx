    ...
    return (
      ...
      <CardContent className={classes.info}>
        <div
          ...
          <Skeleton animation='wave' variant='circle'  width={30} height={30} style={{ marginRight: '5px' }} />
      ...
      <CardActions className={classes.action}>
                ...
                <Skeleton animation='wave' variant='circle'  width={40} height={40} style={{ marginRight: '5px' }} />
      </CardActions>
    </Card>
    )
}
